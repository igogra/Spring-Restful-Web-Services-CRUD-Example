package io.igogra.javacrud.service;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import io.igogra.javacrud.bean.Country;

/*
 * It is just a helper class which should be replaced by database
 * implementation. It is not very well written class, it is just used for
 * demonstration.
 */
